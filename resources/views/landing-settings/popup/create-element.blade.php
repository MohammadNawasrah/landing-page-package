...
<form method="post" action="{{ route('landing-settings.post-element') }}">
    @csrf
    @php
    $landingElement=new \Nozom\LandingPagePackage\Models\LandingElement();
    @endphp
            ...
            <div class="col-6">
                <div class="form-floating mb-3">
                    <select  class="form-control" name="type" id="type">
                        ...
                        <option value= "{{HTML}}" data-tag="{{$landingElement->getElementByType(HTML)}}">{{__(HTML)}} </option>
                        <option value="{{COLOR}}" data-tag="{{$landingElement->getElementByType(COLOR)}}">{{__(COLOR)}} </option>
                        <option value="{{SWITCH_TYPE}}" data-tag="{{$landingElement->getElementByType(SWITCH_TYPE)}}">{{__(SWITCH_TYPE)}} </option>
                        <option value="{{IMAGE}}" data-tag="{{$landingElement->getElementByType(IMAGE)}}">{{__(IMAGE)}} </option>
                        <option value="{{SVG}}" data-tag="{{$landingElement->getElementByType(SVG)}}">{{__(SVG)}} </option>
                        <option value="{{IMAGE_URL}}" data-tag="{{$landingElement->getElementByType(IMAGE_URL)}}">{{__(IMAGE_URL)}} </option>
